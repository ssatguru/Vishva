...
export class ColorPickerFld {
    ...
    <div>
        <div class='w3-cell-row' style="width:100%">
            <input type='text' class='colorInputValue w3-input w3-cell vinput'  style='width:40%;min-width:8em' title='enter color in hex #hhhhhh'></input>
            <input type='text' class='colorInput w3-input w3-cell vinput' style='cursor: pointer;width:60%'  readonly></input>
        </div>
