...
<div id="navMenubar" style="display: inline-block; position: absolute; display: block;">
        <button id="downWorld"><span class="ui-icon ui-icon ui-icon-arrowthickstop-1-s" title="download scene"></span></button>
        <button id="navItems" title="list items">items in world</button>
        <button id="navCAssets">curated assets</button>
        <button id="navAdd" title="add assets">assets</button>
