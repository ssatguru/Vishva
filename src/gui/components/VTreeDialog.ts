...
export class VTreeDialog {
    ...
    constructor(vishva: Vishva, diagTitle: string, pos: string, treeData: Array<string | object>, filter?: string, openAll?: boolean, modal: boolean=true) {
        this._vishva = vishva;
        ...
        this._treeDiag = new VDiag(diagDiv, diagTitle, pos, UIConst._diagWidth,null,null,modal);
