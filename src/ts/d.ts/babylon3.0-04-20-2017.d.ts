...
declare module BABYLON {
    class DirectionalLight extends Light implements IShadowLight {
         ...
         * Returns the DirectionalLight.
         */
        transferToEffect(effect: Effect, lightIndex: number): DirectionalLight;
...
declare module BABYLON {
    class HemisphericLight extends Light {
         ...
         */
        transferToEffect(effect: Effect, lightIndex: number): HemisphericLight;
        _getWorldMatrix(): Matrix;
        /**
...
declare module BABYLON {
    ...
    class Light extends Node {
         ...
         */
        getAbsolutePosition(): Vector3;
        transferToEffect(effect: Effect, lightIndex: number): void;
        _getWorldMatrix(): Matrix;
        /**
...
declare module BABYLON {
    class PointLight extends Light implements IShadowLight {
         ...
         */
        transferToEffect(effect: Effect, lightIndex: number): PointLight;
        /**
...
declare module BABYLON {
    class SpotLight extends Light implements IShadowLight {
         ...
         */
        transferToEffect(effect: Effect, lightIndex: number): SpotLight;
        _getWorldMatrix(): Matrix;
        /**
...
declare module BABYLON {
    class UniformBuffer {
         ...
         */
        updateMatrix3x3(name: string, matrix: Float32Array): Effect;
        /**
         * Wrapper for updateUniform.
         * @param {string} name Name of the uniform, as used in the uniform block in the shader.
         * @param {Float32Array} matrix
         */
        updateMatrix2x2(name: string, matrix: Float32Array): Effect;
        /**
         * Wrapper for updateUniform.
         * @param {string} name Name of the uniform, as used in the uniform block in the shader.
         * @param {number} x
